...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x96F10E18, 0x0D)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Name (MBB, 0xA0000000)
            Name (MBL, 0x40000000)
            Name (MAB, 0x0000000660000000)
            Name (MAL, 0x00000079A0000000)
            Name (MAM, 0x0000007FFFFFFFFF)
            Name (NRSB, 0x96F82000)
    ...
    {
        Name (UWSV, 0x02)
        OperationRegion (UWNV, SystemMemory, 0x96F11018, 0x00070000)
    }
